...
export class Inscripcion {
  ...
  // Nuevos campos:
  @ManyToOne(() => Usuario, (usuario) => usuario.inscripcionesAprobadas, {
    nullable: true,
  })
  usuarioAprueba?: Usuario;

  @ManyToOne(() => Usuario, (usuario) => usuario.inscripcionesRechazadas, {
    nullable: true,
  })
  ...
  @ManyToOne(() => Club, (club) => club.inscripciones)
  club: Club;
}
